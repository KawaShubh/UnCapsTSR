...
class DS_Model(BaseModel):
    ...
    def optimize_parameters(self, step):
        ...
        log_d2_total += (g1 + g2+gp)


        log_d2_total.backward(retain_graph=False)
        ...
        # self.log_dict['WGAN_D']=10*gp
        # self.log_dict['WGAN_D2']=10*gp_D2
